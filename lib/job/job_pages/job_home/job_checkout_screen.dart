...
import '../../utils/job_subscription_controller.dart';
import 'job_upi_checkout_screen.dart'; // adjust path if this file lives elsewhere
          ...
          child: Obx(() {
            ...
            return Column(
              ...
              children: [
                ...
                // 🔹 Pay button — takes the candidate to the manual UPI checkout screen.
                // The plan is NOT activated here; JobUpiCheckoutScreen creates a
                // pending transaction that your admin panel approves.
                SizedBox(
                  width: double.infinity,
                  child: ElevatedButton(
                    onPressed: isDisabled
