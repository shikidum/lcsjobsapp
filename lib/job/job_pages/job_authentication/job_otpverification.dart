...
class _JobOtpverificationState extends State<JobOtpverification> {
  ...
  Widget _otpBox(TextEditingController ctrl, BuildContext context) {
    return SizedBox(
      height: height / 16,
      width: height / 16,
      child: TextFormField(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Verifying: +91 ${controller.phoneNumber.value}",
              style: urbanistMedium.copyWith(fontSize: 16),
            ),
            SizedBox(height: height / 46),

            // ✅ Hint banner — tells user what the "OTP" is
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: JobColor.appcolor.withOpacity(0.4)),
              ),
              child: Row(
                children: [
                  const Icon(Icons.info_outline, color: JobColor.appcolor, size: 20),
                  const SizedBox(width: 10),
                  Expanded(
                    child:Text("Enter the last 6 digits of your phone number as OTP\n\nYour OTP is: ${controller.phoneNumber.value.trim().substring(controller.phoneNumber.value.trim().length - 6)}",
                      style: urbanistMedium.copyWith(fontSize: 14, color: JobColor.appcolor),
                    ),
                  ),
                ],
              ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                _otpBox(otp1Controller, context),
                _otpBox(otp2Controller, context),
                _otpBox(otp3Controller, context),
                _otpBox(otp4Controller, context),
                _otpBox(otp5Controller, context),
                _otpBox(otp6Controller, context),
              ],
            ),
            ...
            Obx(() => InkWell(
              onTap: controller.isLoading.value
                  ? null
                  : () {
                final entered = otp1Controller.text +
                    otp2Controller.text +
                    otp3Controller.text +
                    otp4Controller.text +
                    otp5Controller.text +
                ...
                if (entered.length == 6) {
                  controller.verifyOtp(entered, context);
                } else {
