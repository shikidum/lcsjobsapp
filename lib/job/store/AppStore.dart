...
abstract class _AppStore with Store {
  ...
  @action
  Future<void> setUserMobile(String val, {bool isInitialization = false}) async {
    userEmail = val;
    if (!isInitialization) await sharedPref.setString(USER_MOBILE, val);
  }
  @action
