...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$userMobileAtom =
  Atom(name: '_AppStore.userMobile', context: context);
  ...
  String get userMobile {
    _$userMobileAtom.reportRead();
    return super.userMobile;
  }
  ...
  set userMobile(String value) {
    _$userMobileAtom.reportWrite(value, super.userMobile, () {
      super.userMobile = value;
    });
  }
  ...
  late final _$setUserMobileAsyncAction =
  AsyncAction('_AppStore.setUserMobile', context: context);
  ...
  @override
  Future<void> setUserMobile(String val, {bool isInitialization = false}) {
    return _$setUserMobileAsyncAction
        .run(() => super.setUserMobile(val, isInitialization: isInitialization));
  }
